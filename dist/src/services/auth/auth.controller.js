...
let AuthController = class AuthController {
    ...
    setRefreshTokenToCookie(tokens, res) {
        ...
        return res.status(common_1.HttpStatus.CREATED).json({ accessToken: tokens.token });
    }
};
...
__decorate([
    ...
    (0, swagger_1.ApiBody)({ type: dto_1.LoginAdminDto }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Login successful' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.LoginAdminDto, Object]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "Login", null);
__decorate([
    (0, common_1.Get)('logout'),
    (0, swagger_1.ApiOperation)({ summary: 'Logout' }),
    __param(0, (0, cookies_decorator_1.Cookie)(ACCESS_TOKEN)),
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Tokens refreshed' }),
    __param(0, (0, cookies_decorator_1.Cookie)(ACCESS_TOKEN)),
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
